    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        % Si la diferencia entre ambas frecuencias es mayor al 2 %, error.
            if abs(frecuencia_m-frecuencia_f)/frecuencia_f>0.02||...
                    abs(frecuencia_c-frecuencia_f)/frecuencia_f>0.02||...
                    abs(frecuencia_c-frecuencia_m)/frecuencia_m>0.02||...
                    abs(frecuencia_m-frecuencia_nombre)/frecuencia_m>0.02
