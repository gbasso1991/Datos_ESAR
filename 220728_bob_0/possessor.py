...
#Reconstruyo señal impar con ifft p/ muestra
    ...
    figu = plt.figure(figsize=(8,6))
    plt.plot(t,rec_impares)
    #plt.xlim(0,max(t)//2)
    plt.savefig('test_fig04.png',dpi=200)
    #plt.show() 
...
#27 Jul 22 - para sacred_serenity.py
Campo_maximo_c_kAm = []
Frecuencia_c_kHz = []
...
for k in range(len(fnames_m)):
    ...
    #plt.close('all')
    #27 Jul 22 - para sacred_serenity.py
    Campo_maximo_c_kAm.append(max(campo_c)/1000)  #Campo maximo en kA/m
    Frecuencia_c_kHz.append(frec_final_c/1000)
